...
<!-- Mirrored from www.webstrot.com/html/moviepro/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 18:03:14 GMT -->
				...
				<div class="prs_menu_main_wrapper">
					<nav class="navbar navbar-default">
						<div id="dl-menu" class="xv-menuwrapper responsive-menu">
							...
							<ul class="dl-menu">
								<li class="parent"><a href="Homepage.aspx">Home</a>
									
								</li>
								<li class="parent megamenu"><a href="movie1.aspx">movie</a>
									<ul class="lg-submenu">
                                ...
                                <li class="parent"><a href="contact.aspx">contact</a>
                                </li>
			...
			<div class="prs_navi_right_main_wrapper">
				...
				<div class="prs_top_login_btn_wrapper">
					<div class="prs_animate_btn1">
						<ul>
							<li><a href="Login.aspx" class="button button--tamaya" data-text="Login"><span>Login</span></a>
							</li>
						</ul>
					</div>
				</div>
				<div class="prs_top_login_btn_wrapper">
					<div class="prs_animate_btn1">
						<ul>
							<!--<li><a href="Registeration.aspx" class="button button--tamaya" data-text="sign up"><span>sign up</span></a>-->
							</li>
						</ul>
					</div>
				</div>
		...
		<path  d="M39.919,19.833C39.919,8.88,30.984,0,19.959,0C8.937,0,0,8.88,0,19.833
			...
			C37.652,36.448,45.953,40,45.953,40l1.043-8.658C41.41,30.454,38.125,32.244,35.314,34.585z"/>
					...
					<div class="prs_top_login_btn_wrapper prs_slidebar_searchbar_btn_wrapper">
						<div class="prs_animate_btn1">
							<ul>
								<li><a href="#" class="button button--tamaya" data-text="sign up"><span>sign up</span></a>
								</li>
							</ul>
						</div>
					</div>
											...
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													...
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul>
                                                        <li>
															 <a href = "https://youtu.be/JfbxcD6biOk">View Trailer</a>
												
															</li>
															<li><a href="viewdetails.aspx">View Details</a>
															</li>
														</ul>
													</div>
												</div>
												<div class="prs_upcom_movie_content_box">
													<div class="prs_upcom_movie_content_box_inner">
														<h2><a href="#">Gully Boy</a></h2>
														<p>BIOGRAPHY, DRAMA</p>	<i class="fa fa-star"></i>
													...
													<div class="prs_upcom_movie_content_box_inner_icon">
														<ul>
															<li><a href="#"><i class="flaticon-cart-of-ecommerce"></i></a>
															</li>
														</ul>
													</div>
												</div>
											...
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													...
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul>
                                                        <li>
                                                          <a href = "https://youtu.be/NCC6izqds04">view trailer</a>                                                         
                                                        </li>
                                                        <li>
                                                        
															<a href="ViewDetail1.aspx">View Details</a>
															</li>
												...
												<div class="prs_upcom_movie_content_box">
													<div class="prs_upcom_movie_content_box_inner">
														<h2><a href="#">LoveRatri</a></h2>
														<p>Drama , Action</p>	<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
														<i class="fa fa-star"></i>
														<i class="fa fa-star-o"></i>
														<i class="fa fa-star-o"></i>
											...
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													...
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul>
                                                        <li>
															 <a href ="https://youtu.be/ym4EJQ7XORk" >View Trailer</a>
												
															</li>
                                                           
															<li><a href="ViewDetail2.aspx">View Details</a>
											...
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													...
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul>
                                                             <li>
															 <a href ="https://youtu.be/-JLewvWBkCw">>View Trailer</a>
												
															</li>
                                                            
															<li><a href="viewdetail3.aspx">View Details</a>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														...
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul>
                                                              <li>
															 <a href ="https://youtu.be/EJylz_9KYf8">>View Trailer</a>
												
															</li>
                                                            
                                                               
																<li><a href="viewdetail4.aspx">View Details</a>
																</li>
															</ul>
														</div>
													</div>
												...
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														...
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul>
                                                             <li>
															 <a href ="https://youtu.be/nubDFeiUAsI">View Trailer</a>
												
															</li>
                                                            <li><a href="viewdetail5.aspx">View Details</a>
																</li>
                                                             </ul>
														</div>
													</div>
												...
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														...
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul>
                                                            <li>
															 <a href ="https://youtu.be/An4vqppEWXU">View Trailer</a>
										                       </li>
																<li><a href="viewdetail6.aspx">View Details</a>
																</li>
															</ul>
														</div>
													</div>
													<div class="prs_upcom_movie_content_box">
														<div class="prs_upcom_movie_content_box_inner">
															<h2><a href="#">Shadi mein zaroor ana</a></h2>
															<p>Drama , Action</p>	<i class="fa fa-star"></i>
															<i class="fa fa-star"></i>
															<i class="fa fa-star"></i>
															<i class="fa fa-star-o"></i>
												...
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														...
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul>
                                                            <li>
															 <a href ="https://youtu.be/X_5_BLt76c0">View Trailer</a>
										                       </li>
																<li><a href="viewdetail7.aspx">View Details</a>
																</li>
															</ul>
														</div>
													</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="prs_video_sec_icon_wrapper">
						<ul>
							<li><a class="test-popup-link button" rel='external' href='https://youtu.be/dSDikcCOu6s' title='title'><i class="flaticon-play-button"></i></a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
					<div class="prs_bottom_footer_cont_wrapper">
						<p>Copyright 2018 <a href="#">Movie Pro</a> . All rights reserved - Design by <a href="#">Webstrot</a>
						</p>
					</div>
				</div>
...
<!-- Mirrored from www.webstrot.com/html/moviepro/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2019 18:05:04 GMT -->
</html>
    </form>
</body>
</html>

...
public partial class seats : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        aid = random.Next(1001, 9999).ToString();
    ...
    protected void Button17_Click(object sender, EventArgs e)
    {
        ...
        for (i = 0; i < 16; i++)
        {
            ...
            {
                String mycon = (@"Data Source=DESKTOP-82J91LH;Initial Catalog=projectbd;Integrated Security=True");
                String updatedata = "Update SeatStatus set status='booked' where seatno=" + (i + 1);
                SqlConnection con = new SqlConnection(mycon);
                con.Open();
                SqlCommand cmd = new SqlCommand();
        ...
        String query = "insert into Cust_Movies(id,time,date,theatre,Cust_Email) values('" + aid + "','" + ddltime.Text + "','" + txtdate.Text + "','" + ddltheatre.Text + "','" + Convert.ToString(Session["email"]) + "')";
